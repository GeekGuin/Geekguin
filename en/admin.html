        ...
        <div class="container">
          <div class="row">
            <div class="col-md-6">
              ...
              <h2>Portafolios</h2>
              <p class="lead">Puedes agregar o borrar portafolios en esta sección</p>
              <div class="text-right">
                <a href="portfolio_list.html" class="btn btn-danger waves-effect waves-light">Vamos allá</a>
              </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="card-panel hoverable">
              <h2>Articulos</h2>
              <p class="lead">Puedes agregar o borrar articulos en esta sección</p>
              <div class="text-right">
                <a href="#" class="btn btn-danger waves-effect waves-light">Vamos allá</a>
              </div>
              </div>
            </div>
          </div>
